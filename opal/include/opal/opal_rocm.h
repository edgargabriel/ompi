...
struct mca_opal_rocm_reg_data_t {
...
typedef struct mca_opal_rocm_reg_data_t mca_opal_rocm_reg_data_t;

struct mca_opal_rocm_reg_t {
    mca_rcache_base_registration_t base;
    mca_opal_rocm_reg_data_t data;
};
typedef struct mca_opal_rocm_reg_t mca_opal_rocm_reg_t;
#endif /* OPAL_ROCM_H */
