 ...
 * @file
 */
#ifndef MCA_BTL_SMROCM_ENDPOINT_H
#define MCA_BTL_SMROCM_ENDPOINT_H
...
struct mca_btl_base_endpoint_t {
    ...
    opal_proc_t *proc_opal; /**< Needed for adding ROCM IPC support dynamically */
    enum ipcState ipcstate; /**< ROCM IPC connection status */
    int ipctries;           /**< Number of times ROCM IPC connect was sent */
};
